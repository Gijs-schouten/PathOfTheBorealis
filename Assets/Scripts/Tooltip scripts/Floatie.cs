...
{
    //Dit script is voor een tooltip die bij je blijft totdat je lang genoeg naar
    //de "attention point" kijkt.
    ...
    //DEZE IS BELANGRIJK
    [Tooltip("Het object waar je lang genoeg naar moet kijken zodat de tooltip verdwijnt")]
    public Transform attentionPoint;

    //DEZE IS OOK BELANGRIJK
    [Tooltip("De camera waar de tooltip naar kijkt.")]
